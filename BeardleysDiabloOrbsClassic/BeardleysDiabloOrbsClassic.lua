...
local function reconfigUI()
	...
	QuestLogMicroButton:SetPoint("BOTTOM", UIParent, "BOTTOM",-37,-2)
	SocialsMicroButton:SetPoint("BOTTOM", UIParent, "BOTTOM",-10,-2)
	WorldMapMicroButton:SetPoint("BOTTOM", UIParent, "BOTTOM",17,-2)
	MainMenuMicroButton:SetPoint("BOTTOM", UIParent, "BOTTOM",42,-2)
	HelpMicroButton:SetPoint("BOTTOM", UIParent, "BOTTOM",67,-2)
