...
local function reconfigUI()
	...
	CollectionsMicroButton:SetPoint("BOTTOM", UIParent, "BOTTOM",77,-2)
	LFGMicroButton:SetPoint("BOTTOM", UIParent, "BOTTOM",102,-2)
	MainMenuMicroButton:SetPoint("BOTTOM", UIParent, "BOTTOM",127,-2)
	HelpMicroButton:SetPoint("BOTTOM", UIParent, "BOTTOM",152,-2)
